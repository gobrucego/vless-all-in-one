...
- **配置管理功能** - 主菜单新增「配置管理」入口
  - 导出配置：一键备份所有协议配置、分流规则、外部节点到 JSON 文件
  - 导入配置：支持全部导入、选择性导入（协议/分流规则/外部节点）
  - 自动检测更换 IP：服务器 IP 变化后自动更新配置
  - 备份管理：查看、删除备份文件

- **添加节点交互优化** - 粘贴链接后显示解析预览，支持自定义节点名称
- **导入订阅预览** - 导入前显示节点预览列表，确认后再导入
---
...
═════════════════════════════════════════════
  链式代理管理
─────────────────────────────────────────────
  状态: ● 分流已配置 (2 条规则使用链式代理)

  ┌────┬────────────────┬──────────┬────────────────────────┬────────┐
  │ #  │ 名称           │ 协议     │ 地址                   │ 状态   │
  ├────┼────────────────┼──────────┼────────────────────────┼────────┤
  │ 1  │*🇯🇵 JP-Tokyo    │ VLESS    │ jp.example.com:443     │ --     │
  │ 2  │*🇸🇬 SG-Node     │ HY2      │ sg.example.com:10086   │ --     │
  │ 3  │ 🇺🇸 US-Node     │ Trojan   │ us.example.com:443     │ --     │
  └────┴────────────────┴──────────┴────────────────────────┴────────┘
  共 3 个节点  *=已配置分流
...
─────────────────────────────────────────────
  ...
  订阅地址:
  ┌───────────────────────────────────────────────────────┐
  │ V2Ray/通用: https://domain.com:8443/sub/xxx/v2ray    │
  │ Clash:      https://domain.com:8443/sub/xxx/clash    │
  │ Surge:      https://domain.com:8443/sub/xxx/surge    │
  │                                                       │
  │ 包含 3 个协议 × IPv4+IPv6 = 6 个节点                  │
  └───────────────────────────────────────────────────────┘
