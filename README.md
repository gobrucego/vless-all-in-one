...
- 🎯 **多出口分流系统**
  - 支持为不同网站配置不同的代理出口
  - 每条分流规则独立选择出口节点
  - 预设规则：OpenAI、Netflix、Disney+、YouTube、Spotify、TikTok、Telegram、Google
  - 支持自定义域名规则

- 🔗 **链式代理转发**
  - 支持导入机场订阅链接，用机场节点作为分流出口
  - 支持 VMess/VLESS/Shadowsocks/Trojan/Hysteria2 节点
  - 支持单独添加分享链接
...
- 修复 SS2022 协议不加 ShadowTLS 搭建失败的问题

### v3.0.5 (2024-12-29)

- 修复 ShadowTLS 插件启动时 CPU 占用 100% 的问题
